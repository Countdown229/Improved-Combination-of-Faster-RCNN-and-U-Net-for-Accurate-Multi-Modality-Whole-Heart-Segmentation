...
class Config(object):
    ...
    # Channels of the conv output in the Mask graph
    ...
    #hybrid loss and weight
    USE_HYBRID = False#True
    RPN_BBOX_LOSS = "smooth_l1_loss"#"smooth_l1_loss"#"ciou_loss"#"iou_loss"
    MRCNN_BBOX_LOSS = "smooth_l1_loss"#"smooth_l1_loss"#"ciou_loss"#"iou_loss"
    # Loss weights for more precise optimization.
    # Can be used for 3D-Mask-RCNN training setup.
    LOSS_WEIGHTS = {
        "rpn_class_loss": 1.,
        "rpn_bbox_loss": 1.,
        "mrcnn_class_loss": 1.,
    ...
    def __init__(self, stage):
        ...
        if stage == 'finetune':
            ...
            self.MASK_SHAPE = (96, 96, 96)  #(96,96,96)
            self.DETECTION_TARGET_IOU_THRESHOLD = 0.5
